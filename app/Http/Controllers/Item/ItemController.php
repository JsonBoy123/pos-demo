            ...
            foreach ($datas as $value) {
                foreach ($value as $items) {
                    ...
                    /*if($items['expiry_date'] != ""){
                        ...
                        $date = $items['expiry_date'] !='0000-00-00' ? Date::excelToDateTimeObject($items['expiry_date']): Null;
                        $exp_date = $items['expiry_date'] !='0000-00-00' ? date("d/m/Y", strtotime(get_object_vars($date)['date'])) : Null;
                    }else{
                        $exp_date = Null;
                    }*/
                    if($items['category'] !=''){
